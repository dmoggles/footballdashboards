...
class ShotLollipopDashboard(Dashboard):
    ...
    def _plot_lollipops(self, ax: Axes, data: pd.DataFrame):
        ...
        ax.scatter(
            op_goals["minute_int"], op_goals["xg"], s=50, c="green", ec="black", lw=0.5, zorder=2
        )
        ax.scatter(
            op_shots["minute_int"], op_shots["xg"], s=50, c="grey", ec="black", lw=0.5, zorder=2
        )
        ax.scatter(
            deadball_goals["minute_int"],
            deadball_goals["xg"],
