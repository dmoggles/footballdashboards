...
def match_dashboard_header(
    ...
    ax.text(
            x = 0.11, y=y_max * 0.5, s=teams[0], ha="left", va="center", size=16, fontproperties=font_bold.prop, color=edgecolor, zorder=101
        )
    ax.text(
            x = 0.89, y=y_max * 0.5, s=teams[1], ha="right", va="center", size=16, fontproperties=font_bold.prop, color=edgecolor, zorder=101
        )
    ...
    if formations:
        ...
        ax.text(
            x=0.11, y=y_max*0.2, s=formations[0], ha="left", va="center", size=12, fontproperties=font_normal.prop, color=edgecolor, zorder=101
        )
        ax.text(
            x=0.89, y=y_max*0.2, s=formations[1], ha="right", va="center", size=12, fontproperties=font_normal.prop, color=edgecolor, zorder=101
        )
